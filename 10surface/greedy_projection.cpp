/*
 * Description: 无序点云的快速三角化(贪婪投影三角化算法)
 * 贪婪投影三角化（Greedy Projection Triangulation, GPT） 是 PCL 中常用的 点云表面重建算法之一，主要用于从稠密点云生成三角网格
 */
...
int main(int argc, char **argv){
  ...
  pcl::io::loadPCDFile ("../ism_test_cat.pcd", cloud_blob);
  ...
  std::cout << "Mesh polygons: " << triangles.polygons.size() << std::endl;
